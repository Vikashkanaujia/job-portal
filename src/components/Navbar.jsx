  ...
  return (
    <header className='max-w-screen-2xl container max-auto xl:px-24 px-4'>
        <nav className='flex justify-between items-center py-6'>
            ...
            <div className='twxt-base text-primary font-medium space-x-5 hidden lg:block '>
        ...
        <ul>
        {
                ...
                <li className='text-white py-1'><Link to="/login">Log in<input type="button" value="" /></Link></li>
